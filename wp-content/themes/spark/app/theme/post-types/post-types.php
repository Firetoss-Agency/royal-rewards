...
add_action('init', function () {
    ...
    $plural_name     = 'Offers'; // human readable
    $singular_name   = 'Offer'; // human readable
    $slug            = 'offers'; // use hyphens
    $registered_name = 'offers'; // use underscores
    $menu_icon       = 'dashicons-tag'; // https://developer.wordpress.org/resource/dashicons
